    ...
    return (
        <section className={styles.container}>
            ...
            <ol className={styles.mapSentence}>
                ...
                <li>ЭРЭЭН БООМТ</li>
                <div className={styles.mapSequence}>БНХАУ-ын үйлвэрийн бүсээс Эрээн хот хүртэл тээвэрлэлтийн хугацаа дунджаар 7-9 хоног</div>

                <li>УЛААНБААТАР ХОТ</li>
                <div className={styles.mapSequence}>Эрээн хотоос Улаанбаатар хот хүртэл тээвэрлэлтийн хугацаа дунджаар 5-7 хоног</div>
